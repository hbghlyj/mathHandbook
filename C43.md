...
lang=EN-US>=</span><i><span lang=EN-US>ϕ</span><span
...
lang=ZH-CN style='font-family:宋体_GB2312'>式中</span><span lang=EN-US>Δ</span><i><span lang=EN-US>x</span></i><sub><span
...
style='font-family:宋体_GB2312'>的一阶差分，</span><span lang=EN-US>Δ</span><sup><span lang=EN-US>2</span></sup><i><span lang=EN-US>x</span></i><sub><span
lang=EN-US>0</span></sub><span lang=EN-US>=</span><span lang=EN-US>Δ</span><i><span lang=EN-US>x</span></i><sub><span
lang=EN-US>1</span></sub><span lang=ZH-CN style='font-family:宋体_GB2312'>－</span><span
lang=EN-US>Δ</span><i><span lang=EN-US>x</span></i><sub><span
...
lang=EN-US>ϕ</span></i><span lang=EN-US>(<i>x</i>)</span><span
...
<p class=1 align=center style='text-align:center'><i><span lang=EN-US>x</span></i><sub><span
lang=EN-US>1</span></sub><span lang=EN-US>=</span><i><span lang=EN-US>ϕ</span></i><span lang=EN-US> (<i>x</i><sub>0</sub>)</span></p>
<p class=1 align=center style='text-align:center'><i><span lang=EN-US>x</span></i><sub><span
lang=EN-US>2</span></sub><span lang=EN-US>=</span><i><span lang=EN-US>ϕ</span></i><span lang=EN-US> (<i>x</i><sub>1</sub>)</span></p>
...
lang=EN-US>+1</span></sub><span lang=EN-US>=</span><i><span lang=EN-US>ϕ</span></i><span lang=EN-US> (<i>x<sub>n</sub></i>)</span></p>
