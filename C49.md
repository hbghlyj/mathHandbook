...
lang=EN-US>(</span><span lang=EN-US>ξ</span><sub><span
lang=EN-US>1</span></sub><span lang=EN-US>,</span><span lang=EN-US>ξ</span><sub><span lang=EN-US>2</span></sub><span
lang=EN-US>,</span><span lang=EN-US style='font-family:"MT Extra"'>L</span><span
lang=EN-US>,</span><span lang=EN-US>ξ</span><i><sub><span
lang=EN-US>n</span></sub></i><span lang=EN-US>)&lt;</span><span lang=EN-US>ε</span><span lang=EN-US> </span><span lang=ZH-CN
style='font-family:宋体_GB2312'>（</span><span lang=EN-US>ε</span><span
lang=ZH-CN style='font-family:宋体_GB2312'>为在一定精确度下给定的适当小的正数），则认为</span><span
lang=EN-US>ξ</span><sub><span lang=EN-US>1</span></sub><span
lang=EN-US>,</span><span lang=EN-US>ξ</span><sub><span
lang=EN-US>2</span></sub><span lang=EN-US>,</span><span lang=EN-US
style='font-family:"MT Extra"'>L</span><span lang=EN-US> ,</span><span
lang=EN-US>ξ</span><i><sub><span lang=EN-US>n</span></sub></i><span
...
lang=EN-US>&lt;</span><span lang=EN-US>ε</span><span
...
lang=EN-US>=</span><span lang=EN-US>ω</span><i><span
