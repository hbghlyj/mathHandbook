...
lang=EN-US style='font-family:"Times New Roman"'>x</span></i><span lang=EN-US>=</span><span
lang=EN-US>ϕ</span><span lang=EN-US>(<i>y</i>)</span><span
...
lang=EN-US>y</span></i><span lang=EN-US>=<i>f</i>[</span><span lang=EN-US>ϕ</span><span lang=EN-US>(</span><i><span
lang=EN-US style='font-family:"Times New Roman"'>x</span></i><span lang=EN-US>)]</span><span
...
lang=EN-US>≥</span><span lang=EN-US> <i>f</i>(<i>x</i><sub>2</sub>)[</span><span
